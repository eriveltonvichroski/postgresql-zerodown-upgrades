...
It helps you quickly spin up a 3-node cluster of PostgreSQL, managed by Pacemaker, and proxied by PgBouncer and Pgpool.
...
All packages are from Centos7, except for PostgreSQL itself, which is at version 10.4.

The cluster is configured with a single primary, two asynchronous replica.
